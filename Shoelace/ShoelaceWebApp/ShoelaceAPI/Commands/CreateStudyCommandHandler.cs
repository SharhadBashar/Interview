...
namespace Montrium.Connect.ClinicalDirectory.Commands
{
    ...
    public class CreateStudyCommandHandler : IRequestHandler<CreateStudyCommand, ActionResult<Study>>
    {
        ...
        public Task<ActionResult<Study>> Handle(CreateStudyCommand message, CancellationToken cancellationToken)
        {
            return _studyService.CreateStudy(message.Study);
        }
    }
}

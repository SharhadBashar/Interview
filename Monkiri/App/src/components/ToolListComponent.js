...
export default class ToolListComponent extends React.PureComponent {
    ...
    _renderItem = ({ item }) => {
        ...
        return <CategoryCellComponent item={item} onPress={this.props.toolPressed} />
    }
...
class CategoryCellComponent extends React.PureComponent {
    render() {
     ...
     let color = '#5a5a5a';
     let name = 'Compound Interest Calculator';
     let image_uri = `${BASE_URL}/img/ic_taxes.png`
        return (
            <TouchableOpacity onPress={() => { this.props.onPress() }} style={ChallengeCellStyles.itemWrapper}>
